              ...
              return (
                <>
                  ...
                  <ModalFooter color="light-blue">
                    <button /* onClick={() => savePatternMany()} */ type="submit" className="btn bg-green waves-effect">
